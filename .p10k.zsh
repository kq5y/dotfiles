# Generated by Powerlevel10k configuration wizard on 2025-06-12 at 01:12 JST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%F{#a6adc8\}'  # grey foreground
      local      clean='%F{#a6e3a1\}'   # green foreground
      local   modified='%F{#fab387\}'  # yellow foreground
      local  untracked='%F{#74c7ec\}'   # blue foreground
      local conflicted='%F{#f38ba8\}'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%F{#a6adc8\}'  # grey foreground
      local      clean='%F{#a6adc8\}'  # grey foreground
      local   modified='%F{#a6adc8\}'  # grey foreground
      local  untracked='%F{#a6adc8\}'  # grey foreground
      local conflicted='%F{#a6adc8\}'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND='#89b4fa'
  # Custom icon.
  # typeset -g POWERLEVEL9K_BACKGROUND_JOBS_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND='#fab387'
  # Custom icon.
  ...
  #################[ rust_version: rustc version (https://www.rust-lang.org) ]##################
  # Rust version color.
  typeset -g POWERLEVEL9K_RUST_VERSION_FOREGROUND='#89dceb'
